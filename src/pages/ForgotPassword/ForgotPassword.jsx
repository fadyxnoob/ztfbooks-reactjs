...
const ForgotPassword = () => {
  ...
  const baseButtonClass = "py-3 px-8 rounded transition-colors duration-200 text-center";
    ...
    <div className="w-full h-[1440px] d-flex justify-center items-center py-8 bg-[#fff] ">
      ...
      <div className="flex flex-col items-center mb-0">
        <div className="bg-blue-50 p-4 rounded-full mb-12 w-[100px] h-[100px] flex justify-center items-center">
          <BsSearch className="w-12 h-12  h-6 text-blue-800" />
        </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 p-[2.5rem]">
        ...
        <div className="mt-[5rem]">
          ...
          <Button 
            classNames="mt-[4rem] w-full bg-[#01447E] text-[#D2D2D2] py-3 px-4 rounded-md hover:bg-blue-900 transition-colors"
            type="submit"
          >
            Reset Password
          </Button>
