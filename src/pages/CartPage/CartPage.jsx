              ...
              >
                <div className="flex justify-between w-full md:w-auto">
                  ...
                  <div className="md:hidden">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <p className="text-[#7C7C7C] text-sm font-normal">{book.rating || "4.0"}</p>
                ...
                <div className="w-full p-2 flex flex-wrap items-center justify-between">
                  ...
                  <div className="">
                    ...
                    <p className="mt-2 text-[#7C7C7C] text-sm font-normal">{book.author || "Unknown"}</p>
                  </div>
                  <div className="">
                  ...
                  <div>
                    <p className="text-[#7C7C7C] text-sm font-normal">{book.date || "N/A"}</p>
                  </div>
                </div>
              </div>
            ))
