...
import HomeCategoryCard from "../Categories/HomeCategoryCard";

const SeriesCarousel = ({ items, pathTo }) => {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {isEnd && (
        <div className="text-center absolute top-0 right-5 z-20">
          <Link
            to={pathTo}
...
export default React.memo(SeriesCarousel);
